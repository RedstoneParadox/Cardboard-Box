 ...
 */
class TextureRectNode(name: String, x: Float, y: Float, var width : Int, var height : Int , var id : Identifier) : GuiNode(name, x, y) {
    ...
    override fun drawSelf(gui: Gui, float: Float, int1: Int, int2: Int) {
        ...
        gui.drawTexturedRect(int3, int4, 0, 0, (gui as IContainerGui).width, (gui as IContainerGui).height)
    }
}